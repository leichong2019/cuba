...
public abstract class WebAbstractDataGrid<C extends Grid<E> & CubaEnhancedGrid<E>, E extends Entity>
    ...
    public Column<E> addGeneratedColumn(String columnId, GenericColumnGenerator<E, ?> generator) {
        ...
        Class<? extends Renderer> rendererType = (Class<? extends Renderer>) Arrays.stream(column.getRenderer().getClass().getInterfaces())
                .filter(Renderer.class::isAssignableFrom)
                .findFirst()
                .orElseThrow(() ->
                        new DevelopmentException("Renderer should be specified explicitly for generated column: " + columnId));
